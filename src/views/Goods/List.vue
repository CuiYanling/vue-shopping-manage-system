    ...
    <el-card class="box-card" style="width: 100%">
        ...
        <el-table :data="clotheslist" style="width: 100%">
            <el-table-column width="90px" label="商品名称">
                <template #default="scope">
                    <el-image style="width: 80px; height: 80px" :src="scope.row.img_md" fit="fill" />
                    <!-- <el-avatar fit="fill" shape="square" :src="scope.row.img_md" class="img" /> -->
                </template>
            </el-table-column>
        ...
        <div style="display:flex;justify-content:end;margin-top: 10px;">
            <el-pagination v-model:currentPage="currentPage" v-model:page-size="pageSize" :page-sizes="[4, 8, 16, 32]"
                :disabled="disabled" :background="background" layout=" prev, pager, next,sizes" :total="goodsTotal"
