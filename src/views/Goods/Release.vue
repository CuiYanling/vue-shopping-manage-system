    ...
    <el-card>
        ...
        <el-form ref="ruleFormRef" :rules="rules" label-width="120px" label-position="left" :model="form"
            ...
            <el-form-item label="商品主图720" prop="img_lg">
                <el-upload class="avatar-uploader" :action="`${host}/upload/common`" :data="extra" :headers="headers"
                    :show-file-list="false" accept=".jpg,.png,.jpeg" :on-success="handleUploadSuccess1"
                    :on-error="handleUploadError1" :before-upload="handleBeforeUpload1">
            ...
            <el-form-item label="商品主图360" prop="img_md">
                <el-upload class="avatar-uploader" :action="`${host}/upload/common`" :data="extra" :headers="headers"
                    :show-file-list="false" accept=".jpg,.png,.jpeg" :on-success="handleUploadSuccess"
            ...
            <el-form-item label="商品轮播图" prop="slider">
                ...
                <el-dialog v-model="dialogVisibleslider">
...
const dialogVisibleslider = ref(false);
const handleRemove = (uploadFile, uploadFiles) => {
    // console.log(uploadFile, uploadFiles)
}
const handlePictureCardPreview = (uploadFile) => {
    dialogImageUrl.value = uploadFile.url;
    dialogVisibleslider.value = true;
}
