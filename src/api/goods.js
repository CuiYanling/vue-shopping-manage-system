...
//根据id获取商品详情
let goodsseller = (params) => axios.get('/seller/goods', { params });

//发布商品
let release = (data) => axios.post('/seller/goods', data);

//编辑商品
let edit = (id, data) => axios.put(`/seller/goods/${id}`, data);

//商品列表
let list = (params) => axios.get('/seller/goods/list', { params });

//删除
let remove = (id, params) => axios.delete(`/seller/goods/${id}`, { params })
